...
const gameData = {
    ...
    wheelOptions: ["ร้องเพลง 1 ท่อน", "ได้ +1 แต้ม ฟรี!", "โดนหัก -1 แต้ม", "เต้น 10 วินาที", "รอดตัวไป!", "ดื่มน้ำเปล่า 1 แก้ว", "พูดชมคนทางซ้าย", "เล่าเรื่องตลก 1 เรื่อง", "ให้แต้มเพื่อน 1 คน", "ทำหน้าผี"],
    categories: ["ชื่อผลไม้", "ชื่อจังหวัดในไทย", "ยี่ห้อรถยนต์", "ชื่อสัตว์ที่มี 4 ขา", "เมนูอาหารไทย", "ชื่อหนังฮีโร่", "อุปกรณ์เครื่องเขียน", "ชื่อประเทศในเอเชีย", "ยี่ห้อโทรศัพท์มือถือ", "ชื่อเพลงที่กำลังฮิต"],
    fiveSec: [
